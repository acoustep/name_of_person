defmodule NameOfPersonTest do
  ...
  test "first name" do
    assert NameOfPerson.PersonName.first(%NameOfPerson.PersonName{
             first_name: "John",
             middle_name: "Blank",
             last_name: "Smith"
           }) == "John"
  ...
  test "full name" do
    ...
    assert NameOfPerson.PersonName.full(%NameOfPerson.PersonName{
             first_name: "John",
             middle_name: "Blank",
             last_name: "Smith"
           }) == "John Blank Smith"
  ...
  test "familiar name" do
    assert NameOfPerson.PersonName.familiar(%NameOfPerson.PersonName{
             first_name: "John",
             last_name: "Smith"
           }) == "John S."
  ...
  test "abbreviated name" do
    assert NameOfPerson.PersonName.abbreviated(%NameOfPerson.PersonName{
             first_name: "John",
             last_name: "Smith"
           }) == "J. Smith"

    assert NameOfPerson.PersonName.abbreviated(%NameOfPerson.PersonName{first_name: "John"}) ==
             "John"
  ...
  test "sorted name" do
    assert NameOfPerson.PersonName.sorted(%NameOfPerson.PersonName{
             first_name: "John",
             last_name: "Stanley"
           }) == "Stanley, John"
  ...
  test "possessive name" do
    assert NameOfPerson.PersonName.possessive(%NameOfPerson.PersonName{
             first_name: "John",
             last_name: "Stanley"
           }) == "John Stanley's"
  ...
  test "initials of name" do
    assert NameOfPerson.PersonName.initials(%NameOfPerson.PersonName{
             first_name: "John",
             last_name: "Smith"
           }) == "JS"
    ...
    assert NameOfPerson.PersonName.initials(%NameOfPerson.PersonName{
             first_name: "John",
             middle_name: "Quantum Firefox",
             last_name: "Smith"
           }) == "JQFS"
  end

  test "last name" do
    assert NameOfPerson.PersonName.last(%NameOfPerson.PersonName{
             first_name: "John",
             middle_name: "Blank",
             last_name: "Smith"
           }) == {:ok, "Smith"}
  ...
  test "return mentionable name" do
    ...
    assert NameOfPerson.PersonName.mentionable(%NameOfPerson.PersonName{
             first_name: "John",
             middle_name: "Quantum Firefox",
             last_name: "Smith"
           }) == "johns"
